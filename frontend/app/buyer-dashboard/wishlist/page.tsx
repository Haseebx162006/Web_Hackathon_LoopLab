...
const BuyerDashboardWishlistPage = () => {
    ...
    <>
      {!isBuyer ? (
        ...
        <section className="space-y-6">
          <div>
            <p className="text-[10px] font-light uppercase tracking-[0.32em] text-zinc-400">Dashboard</p>
            <h1 className="text-3xl font-light tracking-tight text-zinc-900 sm:text-4xl">My Wishlist</h1>
            <p className="mt-2 text-sm font-light text-zinc-500">View and manage your saved products.</p>
          </div>
...
export default BuyerDashboardWishlistPage;
