  ...
  return (
    ...
    >
      ...
      <div className="flex items-end justify-between gap-4">
        <p className="text-2xl md:text-3xl font-black tracking-tight text-black">{value}</p>
        {hint ? (
          <span className="rounded-full bg-white px-3 py-1 text-[10px] font-black uppercase tracking-wider text-zinc-500">
            {hint}
          </span>
        ) : null}
      </div>
